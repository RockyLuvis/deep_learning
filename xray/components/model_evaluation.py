        ...
        try:
            ...
            with torch.no_grad():
                ...
                for _, data in enumerate(test_dataloader):
                    ...
                    '''
                    [ 2024-09-21 11:13:19,001 ] 90 root - INFO - Actual_Labels : tensor([1, 1])     Predictions : tensor([1, 1])     labels : 0.0000
                    [ 2024-09-21 11:13:19,001 ] 104 root - INFO - Model  -->   Loss : 5.663629935830735 Accuracy : 49.523809523809526 %
                    '''
