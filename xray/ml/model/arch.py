...
class Net(nn.Module): #My Network architecture
    def __init__(self):
        """ #In this architecture 9 Convolutional blocks are added, 9 convolutional layers
        Creating custom CNN architecture for Image classification
        """
        super(Net, self).__init__() # To inherit parent Nueral network
    ...
    def forward(self, x) -> float: #Forward propogation bus
